...
namespace Helium.Commons.Logging.Default
{
	public class DefaultFileLogger : ILogger
	{
		...
		{
			this.LogMessage(new EventData(0, 0, 0, 0, null), LogLevel.Info, message);
		}
		...
		{
			this.LogMessage(new EventData(0, 0, 0, 0, null), LogLevel.Debug, message);
		}
		...
		{
			this.LogMessage(new EventData(0, 0, 0, 0, null), LogLevel.Trace, message);
		}
		...
		{
			this.LogMessage(new EventData(0, 0, 0, 0, null), LogLevel.Warning, message);
		}
		...
		{
			this.LogMessage(new EventData(0, 0, 0, 0, null), LogLevel.Error, message);
		}
		...
		{
			this.LogMessage(new EventData(0, 0, 0, 0, null), LogLevel.Critical, message);
		}
		...
		{
			this.LogMessage(new EventData(0, 0, 0, 0, null), LogLevel.Fatal, message);
		}
