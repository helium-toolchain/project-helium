...
{
	internal List<Double> Children { get; set; }
	...
	public static Byte Declarator => 0x1B;
	...
	public String Name
	{
		...
		set
		{
			CastleRootToken root = this.RootToken as CastleRootToken ?? throw new ArgumentException(
				$"Root token of CastleDoubleArrayToken {NameId} was not of type CastleRootToken");
	...
	public void CopyTo(Double[] array, Int32 arrayIndex)
	{
	...
	public Int32 IndexOf(Double item)
	{
		return this.Children.IndexOf(item);
	}

	public void Insert(Int32 index, Double item)
	{
	...
	{
		throw new NotImplementedException("The NBT specification does not contain a valid datatype to convert a DoubleArrayToken to");
	}
