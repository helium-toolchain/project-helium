...
public struct SpawnLivingEntityPacket : IPacket
{
	...
	/// <summary>
	/// The entity type, same as in <see cref="SpawnEntityPacket"/>, relevant for <see cref="Data"/>.
	/// </summary>
	...
	{
		stream.WriteVarInt(this.Id.Length + this.EntityId.Length + this.Type.Length + 54);
